...
def scrap_all():
    df = pd.read_csv('../../../data/oriental_store/oriental_store_crawl.csv')
    ...
    df_products.to_csv('../../data/oriental_store/oriental_store_products.csv')
...
def crawl_all():
    ...
    df.to_csv('../../data/oriental_store/oriental_store_crawl.csv')
